...
extern "C" {
#endif
void  rmaPropagate0_p_map_table_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_map_table_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_f_map_table_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate0_r_map_table_simv_daidir (UB  * pcode);
void  rmaPropagate0_wn_map_table_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_p_map_table_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_map_table_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_f_map_table_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate1_r_map_table_simv_daidir (UB  * pcode);
void  rmaPropagate1_wn_map_table_simv_daidir (UB  * pcode, scalar  val);
